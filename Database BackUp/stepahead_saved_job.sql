...
CREATE TABLE `saved_job` (
  ...
  KEY `FKqxv70imao2jaeb01s3hqjpe4i` (`jobId`),
  CONSTRAINT `FK4jvedd82lsoyy2etbtklw3suo` FOREIGN KEY (`personId`) REFERENCES `tbljobseeker` (`personId`),
  CONSTRAINT `FKqxv70imao2jaeb01s3hqjpe4i` FOREIGN KEY (`jobId`) REFERENCES `tbljob` (`jobId`)
...
-- Dump completed on 2016-04-26  8:41:45
